...
export default function BlogPostPage() {
  const blogData = {
    ...
    description: "The message we get when someone says '12th Fail' is that the person studied till standard 12th but could not clear the final exam. He gave up trying again to pass the Final Examination so as to study further. He/she became a defeatist rather than using this setback to rebounce back with gusto. They considered this Failure as an end to their world of doing well and started doing some odd jobs or joined their family business whether big or small scale and lived in utter rejection and dejection. They neither attempted to do anything big in life nor loved with their chin up to face the world. They lived the rest of life in utter low self esteem and shame.",
    likes: "1.2K",
    comments: 6,
