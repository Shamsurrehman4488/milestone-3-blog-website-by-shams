...
export default function BlogPostPage() {
  const blogData = {
    ...
    description: " Apollo 11 1 of 3 Apollo 11Launch of Apollo 11, July 16, 1969.Apollo program infographic.2 of 3 Apollo program infographic.The Apollo program: Major elements of the U.S. Apollo program, showing the Saturn V launch vehicle and configurations of the Apollo spacecraft modules at launch and during their journey to the Moon in an infographic.Explore the timeline of the Apollo missions that led the United States to land the first humans on the Moon 3 of 3 Explore the timeline of the Apollo missions that led the United States to land the first humans on the MoonTimeline and infographic of the Apollo space missions.From the time of its launch on July 16, 1969, until the return splashdown on July 24, almost every major aspect of the flight of Apollo 11 was witnessed via television by hundreds of millions of people in nearly every part of the globe.",
    likes: "1.2K",
    comments: 6,
