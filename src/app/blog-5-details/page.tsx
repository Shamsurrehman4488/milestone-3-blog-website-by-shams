...
export default function BlogPostPage() {
  const blogData = {
    ...
    description: "Artificial intelligence (AI) is the hottest buzzword at the moment, and almost every major company is adding some kind of AI features to its product or service. Unfortunately, while the term sounds like it should have an easy and clear definition, it really doesn't. What researchers call a minor advance in machine learning (we'll get to that term), some marketing department is billing as a huge step toward artificial general intelligence (we'll get to that one, too) In a Financial Times profile, sci-fi writer Ted Chiang described artificial intelligence as a poor choice of words in 1954. And, as someone who's been writing about developments in AI for the last decade...",
    likes: "1.2K",
    comments: 6,
